  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-81px)] max-w-7xl items-center px-6 py-12">
      <div className="mx-auto w-full max-w-lg rounded-lg border border-gray-200 bg-white p-8 shadow-sm">
        <p className="text-sm font-medium text-gray-500">Get started</p>
        ...
        <p className="mt-6 text-sm text-gray-600">Already registered? <Link href="/login" className="font-medium text-blue-600">Log in</Link></p>
      </div>
    </main>
  );
}